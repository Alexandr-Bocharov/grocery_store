...
class Category(models.Model):
    ...
    slug_name = models.SlugField(unique=True, **NULLABLE, help_text="поле заполняется автоматически", verbose_name="slug-имя")
...
class Product(models.Model):
    ...
    subcategory = models.ForeignKey(Subcategory, on_delete=models.CASCADE, verbose_name="подкатегория", related_name="products")
